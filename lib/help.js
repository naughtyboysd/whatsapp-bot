...
┷┯ ☾ Others Commands ☽
   ...
   ╿
   ╿
   ╰╼❥COk , kalo ga ngerti pake aja command !readme tod.`
}
exports.help = help()
function readme() {
    return `
...
function info() {
    return `Bot Ini Dibuat Ma Adit Anjeng

Oh Iya Kontol , Yuda Anjeng.`
}
exports.info = info()
function snk() {
    return `Syarat dan Ketentuan Bot *Vioon Bot* Anjeng Simak Ni PPK
...
exports.snk = snk()
function donate() {
    return `Halo Bos , Anjay Mau Donate Tuh?
